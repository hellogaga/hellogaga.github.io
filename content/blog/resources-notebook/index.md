...
title: "Notebook"
date: 2021-05-29
summary: "A collection of useful code snippets for Python, Pandas, Matplotlib, VPN setup, and OpenWrt configuration."
categories:
  - Notebook
tags:
  - programming
...
- when wanting to use Chinese font, using the following when drawing figures.
  ...
  ```
  <div style="text-align: center"><img src="/images/piechart_chinese.png" alt="food pie chart" width="800"/></div>
...
<div style="text-align: center"><img src="/images/firefox_proxy.png" alt="food pie chart" width="600"/></div>
<div style="text-align: center"><img src="/images/firefox_ip.png" alt="food pie chart" width="600"/></div>
...
<div style="text-align: center"><img src="/images/lan_setup.png" alt="rpi lan setup" width="600"/></div>
...
<div style="text-align: center"><img src="/images/wifi_setup.png" alt="rpi wifi setup" width="600"/></div>
...
<div style="text-align: center"><img src="/images/SSR_setup1.png" alt="rpi SSR setup" width="600"/></div>
<div style="text-align: center"><img src="/images/SSR_setup2.png" alt="rpi SSR setup" width="600"/></div>
<div style="text-align: center"><img src="/images/SSR_setup3.png" alt="rpi SSR setup" width="600"/></div>
<div style="text-align: center"><img src="/images/SSR_setup4.png" alt="rpi SSR setup" width="600"/></div>
