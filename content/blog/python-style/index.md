...
date: 2021-02-16
summary: "Guidelines and tools for writing Python code that follows PEP 8 style conventions."
categories:
  - Blog
tags:
  - Python
...
A list of common rules can be found [here](https://www.flake8rules.com/). You can find both good and bad practices. For example, E111 is _Indentation is not a multiple of four_. That implies that the indentation did not follow the convention. The document might followed indentation of two spaces, which are convention in some companies.
