...
date: 2021-03-08
summary: "Mirror and control your Android phone from a Linux desktop using SCRCPY, including USB and WiFi connections."
categories:
  - Blog
tags:
  - linux
...
<div style="text-align: center"><img src="/images/usb_debug.png" alt="usb_debug" width="400"/></div>
...
**BUG**: It seems that there is a bug when connected over wifi. The phone cannot be stayed awake. The screen will go off after a while. 3. Enjoy. 4. To switch back to USB mode: `adb usb`

<div style="text-align: center"><img src="/images/connection_over_wifi.png" alt="wifi_connection" width="800"/></div>
